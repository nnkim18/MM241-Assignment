...
class Policy2312664_2313303_2313508_2213696_1852316(Policy):
    def __init__(self, policy_id=1):
        assert policy_id in [1,2,3,4]

        # Student code here
        self.current_policy = policy_id
        self.bf1_policy = BF_1_Policy()
        self.bf2_policy = BF_2_Policy()
        self.sa_policy = SA_Policy()
        self.ffd_policy = FFD_Policy()
        if policy_id == 1:
            pass
        elif policy_id == 2:
            pass
    ...
    def get_action(self, observation, info):
        # Student code here
        if self.current_policy == 1:
            return self.bf1_policy.get_action(observation, info)
        elif self.current_policy == 2:
            return self.bf2_policy.get_action(observation, info)
        elif self.current_policy == 3:
            return self.ffd_policy.get_action(observation, info)
        elif self.current_policy == 4:
            return self.sa_policy.get_action(observation, info)
        pass
#BF
class BF_1_Policy(Policy):
    def __init__(self):
        # Student code here
...
#SA
class SA_Policy(Policy):
    def __init__(self, initial_temperature=100, cooling_rate=0.99):
