import torch
from student_submissions.s2210xxx.model import PPO
...
class Policy2313205(Policy):
    ...
    def __init__(self, actor_path="student_submissions/s2210xxx/actor_ppo_checkpoint.pth",
                 critic_path="student_submissions/s2210xxx/critic_ppo_checkpoint.pth", device=None):
        """
