...
class GeneticAlgorithmPolicy(Policy):
    ...
    def _generate_random_chromosome(self, observation):
        ...
        for prod in observation["products"]:
            if prod["quantity"] > 0:
                ...
                chromosome.append(
                    {"stock_idx": stock_idx, "position": position, "prod_size": prod["size"]})
        return chromosome
    ...
    def _mutate(self, chromosome, observation):
        ...
        chromosome[mutation_point]["stock_idx"] = random.randint(
...
class Policy2313866_2313867_2310975_2310554_2313037(Policy):
